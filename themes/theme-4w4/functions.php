...
function theme_4w4_scripts() {
	...
	wp_enqueue_style( 'theme-4w4-google-fonts', 'https://fonts.googleapis.com/css2?family=Open+Sans+Condensed:wght@300;700&display=swap', false ); 
...
//AJOUT D'UN ECOUTEUR POUR LA LISTE DES COURS
